...
строки и столбца. Аргументы num_rows и num_columns указывают число 
...
def print_operation_table(operation, num_rows=6, num_columns=6):
    '''
    Prints the table with `num_rows` rows and `num_columns` columns

    Adds the result of the `operation` to each cell
    '''
